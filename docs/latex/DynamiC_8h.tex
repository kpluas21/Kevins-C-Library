...
\item 
\#define \mbox{\hyperlink{DynamiC_8h_ac6afabdc09a49a433ee19d8a9486056d}{min}}(a,  b)
\begin{DoxyCompactList}\small\item\em A small macro to determine the smaller of two numbers. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Copyright (c) 2023
\end{DoxyCopyright}
This structure uses void pointers and regular arrays. It handles ints, chars, doubles and floats. Strings are to be implemented soonish... Everything you need should be in this one header file. Simply include it and call the \+\_\+init function. Make sure to include what type you are gonna use the array for. This was not tested for every outcome yet.
...
\mbox{\Hypertarget{DynamiC_8h_ac6afabdc09a49a433ee19d8a9486056d}\label{DynamiC_8h_ac6afabdc09a49a433ee19d8a9486056d}} 
...
A small macro to determine the smaller of two numbers. 
